...
class Tile {
     ...
     */
    constructor(title, subtitle, image, imageAlt) {
        this.title = title;
...
const groupme = new TileAndModal(
    'groupme',
    new Tile('GroupMe Bot', 'Python', 'img/projects/groupme.jpg', 'Phones using GroupMe'),
    new Modal(
        'GroupMe Bot',
        'Chat bot that helps facilitate communication in large group chats',
        [
...
const kanban = new TileAndModal(
    'kanban',
    new Tile('Kanban for VS Code', 'JavaScript, TypeScript', 'img/projects/kanban.jpg', 'Woman using kanban board'),
    new Modal(
...
const pathfinding = new TileAndModal(
    'pathfinding',
    new Tile('Pathfinding Visualizer', 'Java', 'img/projects/pathfinding.jpg', 'Dashed line on map'),
    new Modal(
...
const rotaract = new TileAndModal(
    'rotaract',
    new Tile('Rotaract Event Tracker', 'Ruby on Rails, PostgreSQL', 'img/projects/rotaract.jpg', 'Aggie Rotaract volunteers handing out goods'),
    new Modal(
...
const soar = new TileAndModal(
    'soar',
    new Tile('Project SOAR', 'C++', 'img/projects/soar.jpg', 'Flying quadcopter'),
    new Modal(
        'Project SOAR',
...
const website = new TileAndModal(
    'website',
    new Tile('Personal Website', 'NodeJS, JQuery', 'img/projects/website.jpg', 'My website'),
    new Modal(
        'Personal Website',
...
const hub = new TileAndModal(
    'hub',
    new Tile('The Hub', 'NodeJS, JavaScript', 'img/projects/hub.jpg', 'Landing page of The Hub'),
    new Modal(
        'The Hub', 
...
const ra = new TileAndModal(
    'ra',
    new Tile('Resident Advisor', 'Employment', 'img/experience/ra.jpg', 'Promotional Resident Advisor picture featuring myself'),
    new Modal(
        'Resident Advisor',
...
const sa = new TileAndModal(
    'sa',
    new Tile('Sophomore Advisor', 'Employment', 'img/experience/sa.jpg', 'Sophomore Advisor team after training'),
    new Modal(
        'Sophomore Advisor',
...
const icpc = new TileAndModal(
    'icpc',
    new Tile('Competitive Programming', 'Extracurricular Organization', 'img/experience/icpc.jpg', 'Code on a laptop'),
    new Modal(
...
const bonfire = new TileAndModal(
    'bonfire',
    new Tile('Student Bonfire', 'Community Service', 'img/experience/bonfire.jpg', 'Me carrying a log out of the woods'),
    new Modal(
        'Volunteer',
