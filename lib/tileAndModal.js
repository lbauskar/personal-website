...
class TileAndModal {
    ...
    tileHTML() {
        return `<div class="gallery-item ${this.tile.transformClass}">
            ...
            <div class="text">
                <h2 class="some-above h4">${this.tile.title}</h4>
    ...
    modalHTML() {
        ...
        function makeModalButtons(buttons) {
            const buttonHTML = buttons.map(button => {
                ...
                switch (button.type) {
                    ...
                    case 'private-repo':
                        classList = 'btn-outline-danger no-click';
                        icon = 'fas fa-lock';
                ...
                const disabledText = disabled ? 'tabindex="-1" aria-disabled="true"' : '';
                
                return `<a class="btn ${classList}" ${disabledText} href=${button.href} target="_blank" rel="noreferrer noopener">
                    <i class="${icon}"></i>
                    ${text}
                </a>`;
            }).join('\n');
        ...
        function makeCarousel(images, id) {
            ...
            return `<div id="${id}-carousel" class="carousel slide" data-ride="carousel" data-interval="5000">
...
const groupme = new TileAndModal(
    ...
    new Modal(
        ...
        [{type: 'repo', href: '//github.com/lbauskar/groupme-bot'}], 
        [
            {src: 'img/projects/groupme/1.jpg', alt: 'Phones using GroupMe'},
            {src: 'img/projects/groupme/2.jpg', alt: 'Notification from the bot'}
        ]
    )
);
...
const kanban = new TileAndModal(
    ...
    new Modal(
        ...
        [
            {type: 'repo', href: '//github.com/lbauskar/kanban'},
            {type: 'download', href: '//marketplace.visualstudio.com/items?itemName=lbauskar.kanban'}
        ],
        [
            {src: 'img/projects/kanban/1.jpg', alt: 'Woman using kanban board'},
            {src: 'img/projects/kanban/2.jpg', alt: 'Screenshot of the kanban extension'},
            {src: 'img/projects/kanban/3.jpg', alt: 'Another screenshot of the extension'},
        ]
    )
);
...
const pathfinding = new TileAndModal(
    ...
    new Modal(
        ...
        [{type: 'repo', href: '//github.com/lbauskar/java-pathfinding-visualizer'}],
        [
            {src: 'img/projects/pathfinding/1.jpg', alt: 'Dashed line on map'},
            {src: 'img/projects/pathfinding/2.jpg', alt: 'Unsolved maze'},
            {src: 'img/projects/pathfinding/3.jpg', alt: 'Maze solved with the A* algorithm'}
        ]
    )
);
...
const rotaract = new TileAndModal(
    ...
    new Modal(
        ...
        [
            ...
            {src: 'img/projects/rotaract/2.jpg', alt: 'Landing page of event tracker after signing in'},
            {src: 'img/projects/rotaract/3.jpg', alt: 'Details page for an example event'}
        ]
    )
...
const soar = new TileAndModal(
    ...
    new Modal(
        ...
        [
            'Substantially edited <a href="//github.com/PX4/PX4-Autopilot" target="_blank" rel="noreferrer">Pixhawk firmware</a> to support motor tilting',
...
const website = new TileAndModal(
    'website',
    new Tile('Personal Website', 'NodeJS', 'img/projects/website/1.jpg', 'My website', 'far-below'),
    new Modal(
        'Personal Website',
        "You're looking at it",
        [
            'NodeJS and NginX on the server side',
            'HTML, CSS, and Bootstrap for frontend',
            'Lottie and ThreeJS for complex animations'
        ], 
        [{type: 'repo', href:'//github.com/lbauskar/personal-website'}],
        [
...
const hub = new TileAndModal(
    'hub',
    new Tile('The Hub', 'NodeJS, JavaScript, MongoDB', 'img/projects/hub/1.jpg', 'Landing page of The Hub', 'far-below'),
    new Modal(
        'The Hub', 
        'Aggregates posts from Facebook, Tumblr, and Reddit',
        [
            'NodeJS, HTML, CSS, and JavaScript with a MongoDB backend',
            'Worked as a team with 4 other students',
            'Responsible for account creation and social media API integration'
        ],
        [
            {type: 'private-repo', href: '#'},
            {type: 'link', href: '//csce315-hub.herokuapp.com/'}
        ], 
        [
            {src: 'img/projects/hub/1.jpg', alt: 'Landing page of The Hub'},
            {src: 'img/projects/hub/2.jpg', alt: 'The Hub dashboard showing posts from Tumblr and Reddit'},
            {src: 'img/projects/hub/3.jpg', alt: 'Webpage where you can post to Facebook, Tumblr, and Reddit'}
        ]
    )
);
...
const cvmbs = new TileAndModal(
    'cvmbs',
    new Tile('Student Web Specialist', 'Employment', 'img/experience/cvmbs/1.jpg', 'Veterinary College building at nighttime', 'tiny'),
    new Modal(
        'Student Web Specialist',
        'Texas A&M College of Veterinary Medicine and Biomedical Sciences | 2021 - Present',
        [
            `Manage all the websites under the college's jurisdiction, including: 
            <a href="//vetmed.tamu.edu" target="_blank" rel="noreferrer noopener">vetmed.tamu.edu</a>, <a href="//bims.tamu.edu" target="_blank" rel="noreferrer noopener">bims.tamu.edu</a>, and over a dozen more.`,
            'Continuously improve these sites in terms of SEO, accessibility, and adding new features to meet the growing needs of the college.',
        ],
        [],
        [
            {src: 'img/experience/cvmbs/1.jpg', alt: 'Veterinary College building at nighttime'},
            {src: 'img/experience/cvmbs/2.jpg', alt: 'Landing page of vetmed.tamu.edu'}
        ]
    )
);
...
const experiences = [cvmbs, ra, sa, icpc, bonfire];
module.exports = {
    projects: projects,
